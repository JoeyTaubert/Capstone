...
pub async fn create_index(field: String, ascend: i64) -> Result<(), String>{
    ...
    if field != "_id" && field != "number" && field != "timestamp" && field != "protocol" && field != "source_mac" && field != "source_ip" && field != "source_port" && field != "dest_mac" && field != "dest_ip" && field != "dest_port" && field != "length" && field != "payload" {
